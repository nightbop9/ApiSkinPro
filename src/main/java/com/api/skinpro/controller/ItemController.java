...
public class ItemController {
    ...
    public ResponseEntity<Object> create(@Valid @ModelAttribute ItemDTO itemDTO,
        ...
        return CustomResponseBuilder.ResponseBuild(HttpStatus.OK, "Item criado.");
    }
    ...
    public ResponseEntity<Object> update(@PathVariable Long id, @ModelAttribute ItemDTO itemDTO,
        ...
        return CustomResponseBuilder.ResponseBuild(HttpStatus.OK, "Item atualizado.");
    }

    @DeleteMapping("/delete/{id}")
    public ResponseEntity<Object> delete(@PathVariable Long id) {
        itemService.delete(id);
    return CustomResponseBuilder.ResponseBuild(HttpStatus.OK, "Item excluído");
    }
}
